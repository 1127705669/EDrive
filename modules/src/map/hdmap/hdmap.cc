...
int HDMap::GetLanes(const EDrive::common::PointENU& point, double distance,
                    std::vector<LaneInfoConstPtr>* lanes) const {
  return impl_.GetLanes(point, distance, lanes);
}

int HDMap::GetJunctions(const EDrive::common::PointENU& point, double distance,
                        std::vector<JunctionInfoConstPtr>* junctions) const {
  return impl_.GetJunctions(point, distance, junctions);
}

int HDMap::GetSignals(const EDrive::common::PointENU& point, double distance,
                      std::vector<SignalInfoConstPtr>* signals) const {
  return impl_.GetSignals(point, distance, signals);
}

int HDMap::GetCrosswalks(const EDrive::common::PointENU& point, double distance,
                         std::vector<CrosswalkInfoConstPtr>* crosswalks) const {
  return impl_.GetCrosswalks(point, distance, crosswalks);
}

int HDMap::GetStopSigns(const EDrive::common::PointENU& point, double distance,
...
int HDMap::GetYieldSigns(
    const EDrive::common::PointENU& point, double distance,
...
int HDMap::GetRoads(const EDrive::common::PointENU& point, double distance,
...
int HDMap::GetNearestLaneWithHeading(const EDrive::common::PointENU& point,
...
int HDMap::GetLanesWithHeading(const EDrive::common::PointENU& point,
                               const double distance,
                               const double central_heading,
                               const double max_heading_difference,
                               std::vector<LaneInfoConstPtr>* lanes) const {
...
int HDMap::GetRoadBoundaries(
    const EDrive::common::PointENU& point, double radius,
