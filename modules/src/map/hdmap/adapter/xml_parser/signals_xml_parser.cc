...
Result_state SignalsXmlParser::ParseTrafficLights(
...
Result_state SignalsXmlParser::ToPbSignalType(const std::string& xml_type,
...
Result_state SignalsXmlParser::ToPbSubSignalType(const std::string& xml_type,
                                           PbSubSignalType* sub_signal_type) {
...
Result_state SignalsXmlParser::ParseStopSigns(
    const tinyxml2::XMLElement& xml_node,
...
Result_state SignalsXmlParser::ParseYieldSigns(
    const tinyxml2::XMLElement& xml_node,
